		...
		<tr>
			<td>
				<a href="${pageContext.request.contextPath }/index.jsp">
					<img src="${pageContext.request.contextPath }/client/images/logo_client.jpg" width="300px" height="50px" border="0">
				</a>
			</td>
			<td style="text-align:right">
				...
				%>
				| <a href="${pageContext.request.contextPath}/logout?activeCode=${user.activeCode}&password=${user.password}" onclick="javascript:return confirm_logout()">用户退出</a>
				<% 	
				}
				%>			
			</td>		
