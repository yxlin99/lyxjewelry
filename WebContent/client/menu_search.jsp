...
<div id="divmenu">
		<a href="${pageContext.request.contextPath}/showProductByPage?category=earings">耳环</a> 
		<a href="${pageContext.request.contextPath}/showProductByPage?category=necklace">项链</a> 
		<a href="${pageContext.request.contextPath}/showProductByPage?category=set">套装</a>  
	...
	<table width="100%" border="0" cellspacing="0">
		<tr>
			<td style="text-align:right; padding-right:220px">
				Search 
				<input type="text" name="textfield" class="inputtable" id="textfield" value="请输入产品名"
