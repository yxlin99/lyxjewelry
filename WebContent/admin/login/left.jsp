...
<head>
	...
	<body>
		...
		<table width="100%" border="0">
			  <tr>
			  	<td><a href="${pageContext.request.contextPath}/admin/salesman/salesman_list.jsp" target="mainFrame" class="left_list">人员管理</a></td>
			  </tr>
			  <tr>
			  	<td><a href="${pageContext.request.contextPath}/admin/products/download.jsp" target="mainFrame" class="left_list">销售榜单</a></td>
			  </tr>
			  <tr>
			  	<td><a href="${pageContext.request.contextPath}/admin/log_list.jsp" target="mainFrame" class="left_list">显示登录日志</a></td>
			  </tr>
			  <tr>
			  ...
			  <tr>
				...
				<tr>
			  	<td><a href="${pageContext.request.contextPath}/index.jsp" target="wholeframe" class="left_list">退出系统</a></td>
			  </tr>
		</table>
	</body>
</html>
