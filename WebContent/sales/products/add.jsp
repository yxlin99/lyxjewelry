...
<body>
	<form id="userAction_save_do" name="Form1"
		...
		<table cellSpacing="1" cellPadding="5" width="100%" align="center"
			...
			<tr>
				<td align="center" bgColor="#f5fafe" class="ta_01">商品材质：</td>
				
				<td class="ta_01" bgColor="#ffffff">
					<input type="text" name="material" class="bg" />
				</td>
				
			
				<td align="center" bgColor="#f5fafe" class="ta_01">商品颜色：</td>
				<td class="ta_01" bgColor="#ffffff">
					<input type="text" name="color" class="bg" />	
				</td>
			</tr>
			<TR>
